 ...
 */
export declare const ATTRIBUTE_TYPE = "attribute";
...
export declare const enum MultilineType {
    /**
...
export declare const ELEMENT_TYPE = "element";
export declare const EDMX_NAMESPACE_ALIAS = "Edmx";
export declare const EDM_NAMESPACE_ALIAS = "Edm";
...
export declare const REFERENCE_TYPE = "reference";
/**
...
export declare const NAMESPACE_TYPE = "namespace";
/**
...
export declare const TARGET_TYPE = "target";
/**
...
export declare const ANNOTATION_FILE_TYPE = "annotation-file";
/**
 ...
 */
export declare function createAttributeNode(name: string, value: string, nameRange?: Range, valueRange?: Range): Attribute;
/**
 * Creates text node.
 *
 * @param text text
 ...
 */
export declare function createTextNode(text: string, range?: Range, fragmentRanges?: Range[], multilineType?: MultilineType): TextNode;
/**
 ...
 */
export declare function createElementNode({ name, range, nameRange, attributes, content, contentRange, namespace, namespaceAlias }: {
    name: string;
    range?: Range;
    nameRange?: Range;
    attributes?: Attributes;
...
export declare const GHOST_FILENAME_PREFIX = "!";
 ...
 */
export declare function createTarget(path: string): Target;
/**
 ...
 */
export declare function createNamespace(namespace: string, alias?: string, ranges?: {
    range?: Range;
    nameRange?: Range;
    aliasRange?: Range;
    contentRange?: Range;
 ...
 */
export declare function createReference(name: string, alias?: string, uri?: string, ranges?: {
    range?: Range;
    nameRange?: Range;
    aliasRange?: Range;
    uriRange?: Range;
