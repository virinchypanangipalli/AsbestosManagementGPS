...
exports.convertMetadataToAvtSchema = void 0;
/**
 *
 */
class MetadataConverter {
    ...
    convertAction(targetKinds, element) {
    ...
    convertEntityContainer(targetKinds, element, elementKey) {
    ...
    convertFunctionImport(targetKinds, element) {
    ...
    convertEntitySet(targetKinds, element) {
    ...
    convertSingleton(targetKinds, element) {
    ...
    convertComplexType(targetKinds, element, elementKey) {
        if (targetKinds.includes('ComplexType')) {
            const complexTypeProperties = [];
            const complexTypeNavProperties = [];
            for (const subElement of element.content ?? []) {
                const subElementTargetKinds = this.metadataService.getEdmTargetKinds(subElement.path);
    ...
    convertEntityType(targetKinds, element, elementKey) {
    ...
    convertProperty(entityProperties, keys, parent, targetKinds, element) {
    ...
    convertNavigationProperty(navigationProperties, targetKinds, element) {
...
function convertFunctionImportV2(element, targetKinds, metadataService) {
    const action = {
        _type: 'Action',
        name: element.name,
        fullyQualifiedName: element.path,
...
function isReturnParameter(elementTargetKinds, element) {
    return ((elementTargetKinds.includes('Parameter') && element.name === '$Return') ||
 ...
 */
function convertMetadataToAvtSchema(metadataService) {
    const converter = new MetadataConverter(metadataService);
    return converter.convert();
}
exports.convertMetadataToAvtSchema = convertMetadataToAvtSchema;
