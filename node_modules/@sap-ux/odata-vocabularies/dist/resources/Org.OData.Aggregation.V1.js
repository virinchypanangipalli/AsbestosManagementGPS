    ...
    'Org.OData.Aggregation.V1': {
        ...
        'ApplySupportedBase': {
            ...
            'From': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': true,
                '@Org.OData.Core.V1.Description': 'The service supports the `from` keyword in an `aggregate` transformation'
            }
        },
        'ApplySupportedType': {
            '$Kind': 'ComplexType',
            ...
            'PropertyRestrictions': {
                ...
                '@Org.OData.Core.V1.Description': 'Only properties marked as `Groupable` can be used in the `groupby` transformation, and only those marked as `Aggregatable` can be used in the  `aggregate` transformation'
            },
            'GroupableProperties': {
                '$Collection': true,
                '$Type': 'Edm.AnyPropertyPath',
                '@Org.OData.Core.V1.Description': 'A non-empty collection indicates that only the listed properties of the annotated target are supported by the `groupby` transformation'
            },
            'AggregatableProperties': {
                '$Collection': true,
                '$Type': 'Org.OData.Aggregation.V1.AggregatablePropertyType',
                '@Org.OData.Core.V1.Description': 'A non-empty collection indicates that only the listed properties of the annotated target can be used in the `aggregate` transformation, optionally restricted to the specified aggregation methods'
            }
        },
        'AggregatablePropertyType': {
            ...
            'SupportedAggregationMethods': {
                ...
                '@Org.OData.Core.V1.Description': 'Standard and custom aggregation methods that can be applied to the property. If omitted, all aggregation methods can be applied'
            },
        ...
        'AggregationMethod': {
            ...
            '@Org.OData.Core.V1.LongDescription': 'Custom aggregation methods MUST use a namespace-qualified name, that is contain at least one dot. ',
            '@Org.OData.Validation.V1.AllowedValues': [
                {
                    'Value': 'sum',
                    '@Org.OData.Core.V1.Description': 'Can be applied to numeric values to return the sum of the non-null values, or null if there are no non-null values or the input set is empty'
                },
                {
                    'Value': 'min',
                    '@Org.OData.Core.V1.Description': 'Can be applied to values with a totally ordered domain to return the smallest of the non-null values, or null if there are no non-null values or the input set is empty'
                },
                {
                    'Value': 'max',
                    '@Org.OData.Core.V1.Description': 'Can be applied to values with a totally ordered domain to return the largest of the non-null values, or null if there are no non-null values or the input set is empty'
                },
                {
                    'Value': 'average',
                    '@Org.OData.Core.V1.Description': 'Can be applied to numeric values to return the sum of the non-null values divided by the count of the non-null values, or null if there are no non-null values or the input set is empty'
                },
                {
                    'Value': 'countdistinct',
                    '@Org.OData.Core.V1.Description': 'Counts the distinct values, omitting any null values',
                    '@Org.OData.Core.V1.LongDescription': 'For navigation properties, it counts the distinct entities in the union of all entities related to entities in the input set. \n                  For collection-valued primitive properties, it counts the distinct items in the union of all collection values in the input set.'
                }
            ]
        },
        'RollupType': {
            '$Kind': 'EnumType',
            '@Org.OData.Core.V1.Description': 'The number of `rollup` or `rolluprecursive` operators allowed in a `groupby` transformation',
            'None': 0,
            'None@Org.OData.Core.V1.Description': 'No support for `rollup` or `rolluprecursive`',
            'SingleHierarchy': 1,
            'SingleHierarchy@Org.OData.Core.V1.Description': 'Only one `rollup` or `rolluprecursive` operator per `groupby`',
        ...
        'CustomAggregate': {
            ...
            '@Org.OData.Core.V1.LongDescription': 'This term MUST be applied with a Qualifier, the Qualifier value is the name of the dynamic property. The value of the annotation MUST be the qualified name of a primitive type. The aggregated value will be of that type.'
        },
        ...
        'RecursiveHierarchyType': {
            ...
            'ParentNavigationProperty': {
                ...
                '@Org.OData.Core.V1.Description': 'Property for navigating to the parent node(s). Its type MUST be the entity type annotated with this term, and it MUST be collection-valued or nullable single-valued.'
            }
        },
        'HierarchyQualifier': {
            '$Kind': 'TypeDefinition',
            ...
            '@Org.OData.Core.V1.LongDescription': 'Every recursive hierarchy function defined in this vocabulary has\n- a parameter `HierarchyQualifier` of this type and\n- a parameter `HierarchyNodes` that is a collection of entities of a common type without multiple occurrences of the same entity.\n\n`HierarchyQualifier` is the qualifier of a `RecursiveHierarchy` annotation on the entity type of the collection\ngiven by the `HierarchyNodes` parameter. This specifies a recursive hierarchy that is evaluated by the function.'
        },
        'isnode': [
            {
                '$Kind': 'Function',
                '@Org.OData.Core.V1.Description': 'Is the entity a node of the hierarchy specified by the [parameter pair](#HierarchyQualifier) (`HierarchyNodes`, `HierarchyQualifier`)? (See OData-Data-Agg-v4.0, section 5.5.2.1)',
                '@Org.OData.Core.V1.LongDescription': 'If a node identifier passed to the function is null, the function returns null.',
                '$Parameter': [
                    {
                        '$Name': 'HierarchyNodes',
                        '$Collection': true,
        ...
        'isroot': [
            {
                '$Kind': 'Function',
                '@Org.OData.Core.V1.Description': 'Is the entity a root node of the hierarchy specified by the [parameter pair](#HierarchyQualifier) (`HierarchyNodes`, `HierarchyQualifier`)?',
                '@Org.OData.Core.V1.LongDescription': 'If a node identifier passed to the function is null, the function returns null.',
                '$Parameter': [
                    {
                        '$Name': 'HierarchyNodes',
        ...
        'isdescendant': [
            {
                '$Kind': 'Function',
                '@Org.OData.Core.V1.Description': 'Is the entity a descendant node of the ancestor node in the hierarchy specified by the [parameter pair](#HierarchyQualifier) (`HierarchyNodes`, `HierarchyQualifier`) with at most the specified distance? (See OData-Data-Agg-v4.0, section 5.5.2.1)',
                '@Org.OData.Core.V1.LongDescription': 'If a node identifier passed to the function is null, the function returns null.',
                '$Parameter': [
                    {
                        '$Name': 'HierarchyNodes',
        ...
        'isancestor': [
            {
                '$Kind': 'Function',
                '@Org.OData.Core.V1.Description': 'Is the entity an ancestor node of the descendant node in the hierarchy specified by the [parameter pair](#HierarchyQualifier) (`HierarchyNodes`, `HierarchyQualifier`) with at most the specified distance? (See OData-Data-Agg-v4.0, section 5.5.2.1)',
                '@Org.OData.Core.V1.LongDescription': 'If a node identifier passed to the function is null, the function returns null.',
                '$Parameter': [
                    {
                        '$Name': 'HierarchyNodes',
        ...
        'issibling': [
            {
                '$Kind': 'Function',
                '@Org.OData.Core.V1.Description': 'Is the entity a sibling node of the other node in the hierarchy specified by the [parameter pair](#HierarchyQualifier) (`HierarchyNodes`, `HierarchyQualifier`)? (See OData-Data-Agg-v4.0, section 5.5.2.1)',
                '@Org.OData.Core.V1.LongDescription': 'A node is not a sibling of itself. If a node identifier passed to the function is null, the function returns null.',
                '$Parameter': [
                    {
                        '$Name': 'HierarchyNodes',
                        '$Collection': true,
        ...
        'isleaf': [
            {
                '$Kind': 'Function',
                '@Org.OData.Core.V1.Description': 'Is the entity a leaf node in the hierarchy specified by the [parameter pair](#HierarchyQualifier) (`HierarchyNodes`, `HierarchyQualifier`)? (See OData-Data-Agg-v4.0, section 5.5.2.1)',
                '@Org.OData.Core.V1.LongDescription': 'If a node identifier passed to the function is null, the function returns null.',
                '$Parameter': [
                    {
                        '$Name': 'HierarchyNodes',
        ...
        'UpPath': {
            ...
            '$Collection': true,
            '$AppliesTo': ['EntityType'],
            '@Org.OData.Core.V1.Description': 'The string values of the node identifiers in a path from the annotated node to a start node in a traversal of a recursive hierarchy',
            '@Org.OData.Core.V1.LongDescription': 'This instance annotation occurs in the result set after a `traverse` transformation (OData-Data-Agg-v4.0, section 6.2.2.2).\n          A use case for this is traversal with multiple parents, when this annotation takes\n          as value one parent node identifier followed by one grandparent node identifier and so on.'
        },
        'AvailableOnAggregates': {
            '$Kind': 'Term',
            '$Type': 'Org.OData.Aggregation.V1.AvailableOnAggregatesType',
            '$AppliesTo': ['Function'],
            '@Org.OData.Core.V1.Description': 'This function is available on aggregated entities if the `RequiredProperties` are still defined'
        },
        ...
        'CustomAggregateType': {
            ...
            'Name': {
                '@Org.OData.Core.V1.Description': 'Name of the dynamic property that can be used in the `aggregate` transformation'
            },
            'Type': {
                '@Org.OData.Core.V1.Description': 'Qualified name of a primitive type. The aggregated value will be of that type'
            }
        }
    }
};
//# sourceMappingURL=Org.OData.Aggregation.V1.js.map