...
exports.default = {
    ...
    'com.sap.vocabularies.Communication.v1': {
        ...
        'AddressType': {
            ...
            'careof': {
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'An intermediary who is responsible for transferring a piece of mail between the postal system and the final addressee'
            },
            'label': {
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Delivery address label; plain-text string representing the formatted address, may contain line breaks'
            },
            'type': {
        ...
        'GeoDataType': {
            ...
            'uri': {
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'This SHOULD use the geo: URL schema defined in RFC5870 which encodes the same information as an Edm.GeographyPoint',
                '@Org.OData.Core.V1.IsURL': true
            },
            'type': {
                '$Type': 'com.sap.vocabularies.Communication.v1.ContactInformationType',
        ...
        'EventData': {
            ...
            'transp': {
                '$Type': 'Edm.Boolean',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Time transparency for busy time searches, true = free, false = blocked'
            },
            'wholeday': {
                '$Type': 'Edm.Boolean',
                '$Nullable': true,
        ...
        'MessageData': {
            ...
            'sender': {
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Agent responsible for the actual transmission of the message, e.g. a secretary'
            },
            'to': {
                '$Collection': true,
            ...
            'bcc': {
                '$Collection': true,
                '@Org.OData.Core.V1.Description': 'List of recipients whose addresses are not to be revealed (blind carbon copy)'
            },
            'subject': {
                '$Nullable': true,
            ...
            'keywords': {
                '$Collection': true,
                '@Org.OData.Core.V1.Description': 'List of important words and phrases that might be useful for the recipient'
            },
            'received': {
                '$Type': 'Edm.DateTimeOffset',
                '$Nullable': true,
...
//# sourceMappingURL=com.sap.vocabularies.Communication.v1.js.map