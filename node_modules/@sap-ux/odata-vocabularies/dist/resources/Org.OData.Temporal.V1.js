...
exports.default = {
    ...
    'Org.OData.Temporal.V1': {
        ...
        'UnitOfTimeDate': {
            ...
            '@Org.OData.Core.V1.LongDescription': 'The period is a contiguous set of days and does not consider the time of the day.',
            'ClosedClosedPeriods': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': false,
                '@Org.OData.Core.V1.Description': 'If `true`, the period end is the last day in the period; if `false`, the period end is the first day after the period'
            }
        },
        'Timeline': {
            '$Kind': 'ComplexType',
        ...
        'TimesliceWithPeriod': {
            ...
            'Timeslice': {
                ...
                '@Org.OData.Core.V1.Description': 'A time slice with the same entity type as the binding parameter of the action',
                '@Org.OData.Core.V1.LongDescription': 'When it appears in the return type of an action in this vocabulary, the time slice has the same entity set as the binding parameter value.'
            }
        },
        'Update': [
            {
                '$Kind': 'Action',
                '$IsBound': true,
                '@Org.OData.Core.V1.Description': 'Updates existing time slices with values from delta time slices whose object keys match and whose periods overlap',
                '@Org.OData.Core.V1.LongDescription': 'The update behavior for a given object key is known from the [SQL statement](https://www.ibm.com/docs/en/db2oc?topic=statements-update)\n          `UPDATE ... FOR PORTION OF BUSINESS_TIME ... WHERE ...`.\n\n`deltaTimeslices` with non-matching object keys and non-overlapping sub-periods of `deltaTimeslices` are disregarded.',
                '$Parameter': [
                    {
                        '$Name': 'timeslices',
                        '$Collection': true,
                    ...
                    },
                    {
                        ...
                        '@Org.OData.Core.V1.Description': 'New time slices whose property values are used to update the `timeslices` collection',
                        '@Org.OData.Core.V1.LongDescription': 'The delta time slices need not contain all properties, but at least the boundary values of the period to change.\n            An absent object key property matches any key property value.\n            New time slices are processed in the order of the collection, which especially matters if some of the specified change periods overlap.'
                    }
                ],
                '$ReturnType': {
                    '$Collection': true,
        ...
        'Upsert': [
            {
                '$Kind': 'Action',
                '$IsBound': true,
                '@Org.OData.Core.V1.Description': 'Like [`Update`](#Update), but additionally inserts those (sub-periods of) `deltaTimeslices` that `Update` disregards',
                '$Parameter': [
                    {
                        '$Name': 'timeslices',
                        '$Collection': true,
                    ...
                    },
                    {
                        ...
                        '$Collection': true,
                        '$Type': 'Org.OData.Temporal.V1.TimesliceWithPeriod',
                        '@Org.OData.Core.V1.Description': 'New time slices to be merged into the `timeslices` collection',
                        '@Org.OData.Core.V1.LongDescription': 'The delta time slices must contain all properties that are needed for insertion.\n            New time slices are processed in the order of the collection, which especially matters if some of the specified change periods overlap.'
                    }
                ],
                '$ReturnType': {
                    '$Collection': true,
        ...
        'Delete': [
            {
                '$Kind': 'Action',
                '$IsBound': true,
                '@Org.OData.Core.V1.Description': 'Deletes (sub-periods of) existing time slices whose object keys match and whose periods overlap `deltaTimeslices`',
                '@Org.OData.Core.V1.LongDescription': 'The deletion behavior for a given object key is known from the [SQL statement](https://www.ibm.com/docs/en/db2oc?topic=statements-delete)\n          `DELETE ... FOR PORTION OF BUSINESS_TIME ... WHERE ...`.\n          The sub-period of an existing time slice that lies outside a given instance of `deltaTimeslices`\n          is kept, effectively shortening the time slice.',
                '$Parameter': [
                    {
                        '$Name': 'timeslices',
                        '$Collection': true,
                    ...
                    },
                    {
                        ...
                        '@Org.OData.Core.V1.LongDescription': 'The delta time slices contain only the boundary values of the period to delete and (parts of) the object key.\n            An absent object key property matches any key property value.'
                    }
                ],
                '$ReturnType': {
                    '$Collection': true,
...
//# sourceMappingURL=Org.OData.Temporal.V1.js.map