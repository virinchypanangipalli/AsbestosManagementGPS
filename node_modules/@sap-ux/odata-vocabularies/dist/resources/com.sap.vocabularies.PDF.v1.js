...
exports.default = {
    ...
    'com.sap.vocabularies.PDF.v1': {
        ...
        '@Org.OData.Core.V1.LongDescription': 'The PDF vocabulary provides information about the PDF format of a response',
        ...
        'FeaturesType': {
            ...
            'FitToPage': {
                ...
                '@Org.OData.Core.V1.LongDescription': 'If this option is selected, the font size is automatically selected in such a way that all columns of a table fit on one page. Other layout options like margin, border and composite cell spacing are adapted accordingly, with respect to the chose scaling factor.'
            },
            'Padding': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': false,
            ...
            'HeaderFooter': {
                ...
                '@Org.OData.Core.V1.LongDescription': 'Headers and footers are areas in the top and the bottom page margins, where you can add page number and date information'
            },
            'ResultSizeDefault': {
                '$Type': 'Edm.Int32',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Default result size',
                '@Org.OData.Core.V1.LongDescription': ' Default result size for PDF documents. Used if $top has not been provided.'
            },
            'ResultSizeMaximum': {
                '$Type': 'Edm.Int32',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Maximum result size',
                '@Org.OData.Core.V1.LongDescription': 'Max result size for PDF documents. Used if $top has been provided and $top > ResultSizeMaximum'
            },
            'IANATimezoneFormat': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': false,
...
//# sourceMappingURL=com.sap.vocabularies.PDF.v1.js.map