...
exports.default = {
    ...
    'Org.OData.Authorization.V1': {
        '$Alias': 'Authorization',
        '@Org.OData.Core.V1.Description': 'The Authorization Vocabulary provides terms for describing authorization requirements of the service',
        ...
        'OAuth2Implicit': {
            '$Kind': 'ComplexType',
            '$BaseType': 'Org.OData.Authorization.V1.OAuthAuthorization',
            '@Org.OData.Core.V1.Description': 'Security note: OAuth2 implicit grant is considered to be not secure and should not be used by clients, see [OAuth 2.0 Security Best Current Practice](https://datatracker.ietf.org/doc/html/draft-ietf-oauth-security-topics.html#name-implicit-grant).',
            'AuthorizationUrl': {
...
//# sourceMappingURL=Org.OData.Authorization.V1.js.map