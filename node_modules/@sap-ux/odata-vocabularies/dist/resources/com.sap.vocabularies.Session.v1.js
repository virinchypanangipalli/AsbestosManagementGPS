...
exports.default = {
    ...
    'com.sap.vocabularies.Session.v1': {
        ...
        'StickySessionSupported': {
            ...
            '$AppliesTo': ['EntitySet'],
            '@Org.OData.Core.V1.Description': 'The annotated entity set allows data modification only within a sticky session',
        ...
        'StickySessionSupportedType': {
            ...
            'AdditionalNewActions': {
                ...
                '@Org.OData.Core.V1.LongDescription': 'Actions have the same binding parameter as the `NewAction` and may have non-binding paramters'
            },
            'EditAction': {
                '$Type': 'com.sap.vocabularies.Common.v1.QualifiedName',
...
//# sourceMappingURL=com.sap.vocabularies.Session.v1.js.map