...
exports.default = {
    ...
    'com.sap.vocabularies.PersonalData.v1': {
        ...
        'DataSubjectRoleDescription': {
            ...
            '@Org.OData.Core.V1.Description': 'Language-dependent description of the role of the data subjects in this set (e.g. employee, customer)',
            '@Org.OData.Core.V1.LongDescription': 'Values are application-specific.\n          Can be a static value or a `Path` expression If the role varies per entity'
        },
        'EntitySemanticsType': {
            '$Kind': 'TypeDefinition',
            ...
            '@Org.OData.Validation.V1.AllowedValues': [
                {
                    'Value': 'DataSubject',
                    '@Org.OData.Core.V1.Description': 'Entities describing a data subject (an identified or identifiable natural person), e.g. customer, vendor, employee',
                    '@Org.OData.Core.V1.LongDescription': 'These entities are relevant for audit logging. There are no restrictions on their structure. The properties should be annotated suitably with [FieldSemantics](#FieldSemantics).'
                },
                {
                    'Value': 'DataSubjectDetails',
                    '@Org.OData.Core.V1.Description': 'Entities containing details to a data subject (an identified or identifiable natural person) but not representing data subjects by themselves, e.g. street addresses, email addresses, phone numbers',
                    '@Org.OData.Core.V1.LongDescription': 'These entities are relevant for audit logging. There are no restrictions on their structure. The properties should be annotated suitably with [FieldSemantics](#FieldSemantics).'
                },
                {
                    'Value': 'Other',
                    '@Org.OData.Core.V1.Description': 'Entities containing personal data or references to data subjects but not representing data subjects or data subject details by themselves, e.g. customer quote, customer order, purchase order with involved business partners',
                    '@Org.OData.Core.V1.LongDescription': 'These entities are relevant for audit logging. There are no restrictions on their structure. The properties should be annotated suitably with [FieldSemantics](#FieldSemantics).'
                }
            ]
        },
        'FieldSemantics': {
            ...
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'Primary meaning of the personal data contained in the annotated property',
            '@Org.OData.Core.V1.LongDescription': 'Changes to values of annotated properties are tracked in the audit log. Use this annotation also on fields that are already marked as contact or address data.'
        },
        'FieldSemanticsType': {
            '$Kind': 'TypeDefinition',
            '$UnderlyingType': 'Edm.String',
            ...
            '@Org.OData.Validation.V1.AllowedValues': [
                ...
                },
                {
                    ...
                    '@Org.OData.Core.V1.Description': 'The type of ID identifying the data subject and which is allocated when creating a consent record, e.g. an e-mail address or a phone number.'
                },
                {
                    '@com.sap.vocabularies.Common.v1.Experimental': true,
                    'Value': 'ConsentID',
                    '@Org.OData.Core.V1.Description': 'The unique identifier for a consent',
                    '@Org.OData.Core.V1.LongDescription': 'A consent is the action of the data subject confirming that \n                the usage of his or her personal data shall be allowed for a given purpose. \n                A consent functionality allows the storage of a consent record in relation \n                to a specific purpose and shows if a data subject has granted, withdrawn, \n                or denied consent.'
                },
                {
                    '@com.sap.vocabularies.Common.v1.Experimental': true,
                    'Value': 'PurposeID',
                    '@Org.OData.Core.V1.Description': 'The unique identifier for the purpose of a consent',
                    '@Org.OData.Core.V1.LongDescription': 'The purpose of a consent is the information that specifies the reason and the goal for\n                the processing of a specific set of personal data. As a rule, the purpose\n                references the relevant legal basis for the processing of personal data.'
                },
                {
                    'Value': 'ContractRelatedID',
                    '@Org.OData.Core.V1.Description': 'The unique identifier for transactional data that is related to a contract that requires processing of personal data',
                    '@Org.OData.Core.V1.LongDescription': 'Examples:\n\n                - Sales Contract ID\n\n                - Purchase Contract ID\n\n                - Service Contract ID\n                '
                },
                {
                    '@com.sap.vocabularies.Common.v1.Experimental': true,
                    'Value': 'LegalEntityID',
                    '@Org.OData.Core.V1.Description': 'The unique identifier of a legal entity',
                    '@Org.OData.Core.V1.LongDescription': 'A legal entity is a corporation, an association, or any other organization of legal capacity, which has statutory rights and responsibilities.'
                },
                {
                    '@com.sap.vocabularies.Common.v1.Experimental': true,
                    'Value': 'UserID',
                    '@Org.OData.Core.V1.Description': 'The unique identifier of a user',
                    '@Org.OData.Core.V1.LongDescription': 'A user is an individual who interacts with the services supplied by a system.'
                },
                {
                    '@com.sap.vocabularies.Common.v1.Experimental': true,
                    'Value': 'EndOfBusinessDate',
                    '@Org.OData.Core.V1.Description': 'Defines the end of active business and the start of residence time and retention period',
                    '@Org.OData.Core.V1.LongDescription': 'End of business is the point in time when the processing of a set of personal data is no longer required for the active business,\n                for example, when a contract is fulfilled. After this has been reached and a customer-defined residence period has passed, the data is blocked and can only be accessed\n                by users with special authorizations (for example, tax auditors).\n                All fields of type `Edm.Date` or `Edm.DateTimeOffset` on which the end of business determination depends should be annotated.'
                }
            ]
        },
...
//# sourceMappingURL=com.sap.vocabularies.PersonalData.v1.js.map