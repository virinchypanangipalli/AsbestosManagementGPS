...
exports.default = {
    ...
    'com.sap.vocabularies.Common.v1': {
        ...
        'SecondaryKey': {
            ...
            '@Org.OData.Core.V1.Description': 'The listed properties form a secondary key. Multiple secondary keys are possible using different qualifiers.'
        },
        'MinOccurs': {
            '$Kind': 'Term',
            '$Type': 'Edm.Int64',
        ...
        'SemanticObjectMappingType': {
            '$Kind': 'ComplexType',
            '@Org.OData.Core.V1.Description': 'Maps a property of the annotated entity type or a sibling property of the annotated property to a property of the Semantic Object',
            'LocalProperty': {
                '$Type': 'Edm.PropertyPath',
        ...
        'DraftRootType': {
            ...
            'NewAction': {
                ...
                '@Org.OData.Core.V1.LongDescription': 'New drafts may also be created by POSTing an empty entity without any properties to the entity set.'
            },
        ...
        'DraftActivationVia': {
            ...
            '$Type': 'Org.OData.Core.V1.SimpleIdentifier',
            '$AppliesTo': ['EntitySet'],
            '@Org.OData.Core.V1.Description': 'Draft entities in this set are indirectly activated via draft entities in the referenced entity sets'
        },
        'EditableFieldFor': {
            '$Kind': 'Term',
            '$Type': 'Edm.PropertyPath',
