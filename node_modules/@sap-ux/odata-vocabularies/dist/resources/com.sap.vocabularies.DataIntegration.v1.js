...
exports.default = {
    ...
    'com.sap.vocabularies.DataIntegration.v1': {
        ...
        'OriginalDataType': {
            ...
            '@Org.OData.Core.V1.LongDescription': 'The provider of an OData service maps its local type definitions to Edm types. Sometimes, specific type information is lost. This additional annotation gives the consumer hints about the type original type definition.',
        ...
        'OriginalName': {
            ...
            '@Org.OData.Core.V1.LongDescription': 'The provider of an OData service maps its local names to Edm identifiers, which may require removing or replacing characters that are not allowed.',
            '@Org.OData.Core.V1.Example': {
        ...
        'ConversionExit': {
            '$Kind': 'Term',
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'Identifier that describes the special output conversion of the annotated property in the source system',
            '@Org.OData.Core.V1.LongDescription': 'The provider of an OData service maps its local type definitions to Edm types. Sometimes, specific type information is lost. This additional annotation gives the consumer hints about the type original type definition.',
            '@Org.OData.Core.V1.Example': {
        ...
        'SourceSystem': {
            ...
            '@Org.OData.Core.V1.LongDescription': 'The original type name used in annotation OriginalDataType depend are specific to different source system. Sourc system type ABAP uses other type names as source system type HANA.'
        },
        'DeltaMethodType': {
            '$Kind': 'EnumType',
            '$IsFlags': true,
        ...
        'DeltaMethod': {
            ...
            '$AppliesTo': ['EntitySet'],
            '@Org.OData.Core.V1.Description': 'Defines which delta method the entity set supports. Only evaluated if Capabilities.ChangeTracking/Supported is true'
        }
    }
};
//# sourceMappingURL=com.sap.vocabularies.DataIntegration.v1.js.map