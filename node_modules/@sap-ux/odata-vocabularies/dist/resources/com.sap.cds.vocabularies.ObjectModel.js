...
exports.default = {
    'com.sap.cds.vocabularies.ObjectModel': {
        ...
        'ModelingPatternType': {
            ...
            'ANALYTICAL_DIMENSION@Org.OData.Core.V1.Description': 'Annotated entity represents the master data of an analytical cube. Usually should be accompanied by supportedCapabilities "ANALYTICAL_DIMENSION".',
            'ANALYTICAL_FACT': 1,
            'ANALYTICAL_FACT@Org.OData.Core.V1.Description': 'Annotated entity contains transactional data and the relationship to master data entities. Usually should be accompanied by supportedCapabilities "DATA_STRUCTURE".',
            'ANALYTICAL_CUBE': 2,
            'ANALYTICAL_CUBE@Org.OData.Core.V1.Description': 'Describes star schema as an analytical cube. Usually accompanied by supportedCapabilities "ANALYTICAL_PROVIDER" to expose the entity for reporting tools.',
            'LANGUAGE_DEPENDENT_TEXT': 3,
            'LANGUAGE_DEPENDENT_TEXT@Org.OData.Core.V1.Description': 'Annotated entity contains language-dependent text for master data entities. Usually should be accompanied by supportedCapabilities "LANGUAGE_DEPENDENT_TEXT".'
        },
        ...
        'SupportedCapabilitiesType': {
            ...
            '$IsFlags': true,
            'ANALYTICAL_DIMENSION': 0,
            'ANALYTICAL_DIMENSION@Org.OData.Core.V1.Description': 'Defines an entity that represents the master data of an analytical cube. Usually should be accompanied by modelingPattern "ANALYTICAL_DIMENSION".',
            'ANALYTICAL_PROVIDER': 1,
            'ANALYTICAL_PROVIDER@Org.OData.Core.V1.Description': 'Exposes an analytical query for reporting. Usually accompanied by modelingPattern "ANALYTICAL_CUBE".',
            'DATA_STRUCTURE': 2,
...
//# sourceMappingURL=com.sap.cds.vocabularies.ObjectModel.js.map