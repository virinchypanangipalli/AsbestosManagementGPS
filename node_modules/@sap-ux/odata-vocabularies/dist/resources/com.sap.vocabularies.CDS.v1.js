...
exports.default = {
    ...
    'com.sap.vocabularies.CDS.v1': {
        ...
        Title: {
            $Kind: 'Term',
            $Nullable: true,
            '@Org.OData.Core.V1.Description': "Used to add short descriptive texts, frequently used for UI labels and mapped to OData's @Common.Label. Supports i18n by {i18n>...}",
        ...
        Insertonly: {
            ...
            '@Org.OData.Core.V1.Description': 'Signifies the annotated entity as insert-only, i.e. only INSERT operations are allowed.'
        },
        ...
        FioriDraftEnabled: {
            ...
            $DefaultValue: true,
            $AppliesTo: ['EntityType', 'EntitySet'],
            '@Org.OData.Core.V1.Description': 'State store on the server, so user can intrrupt and continue later on. See: https://experience.sap.com/fiori-design-web/draft-handling'
        }
    }
};
/**
...
// },
//# sourceMappingURL=com.sap.vocabularies.CDS.v1.js.map