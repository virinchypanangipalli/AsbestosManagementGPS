...
exports.default = {
    ...
    'Org.OData.Repeatability.V1': {
        ...
        'Supported': {
            ...
            '@Org.OData.Core.V1.Description': 'Repeatable requests are supported for the annotated service, entity set, or action',
            '@Org.OData.Core.V1.LongDescription': 'Annotations on entity set or action import level override an annotation on entity container level, and an annotation on action level override an annotation on action import level. '
        },
        'DeleteWithClientIDSupported': {
            ...
            '@Org.OData.Core.V1.LongDescription': 'Clients that specify a `RepeatabilityClientID` header can delete all remembered requests for that client ID by sending a\n\n`DELETE $RepeatableRequestsWithClientID/{Repeatability-Client-ID}`\n\nrequest to the service root.'
        },
        'DeleteWithRequestIDSupported': {
            ...
            '@Org.OData.Core.V1.LongDescription': 'Clients can delete a single remembered request by sending a\n\n`DELETE $RepeatableRequestWithRequestID/{Repeatability-Request-ID}`\n\nrequest to the service root.'
        }
    }
};
//# sourceMappingURL=Org.OData.Repeatability.V1.js.map