...
exports.default = {
    ...
    'com.sap.vocabularies.UI.v1': {
        ...
        'HeaderInfo': {
            ...
            '@Org.OData.Core.V1.Description': 'Information for the header area of an entity representation. HeaderInfo is mandatory for main entity types of the model'
        },
        'HeaderInfoType': {
            '$Kind': 'ComplexType',
            'TypeName': {
            ...
            'Title': {
                ...
                '@Org.OData.Core.V1.LongDescription': 'This can be a [DataField](#DataField) and any of its children, or a [DataFieldForAnnotation](#DataFieldForAnnotation) targeting [ConnectedFields](#ConnectedFields).',
            ...
            'Image': {
                ...
                '@Org.OData.Core.V1.Description': 'Image for an instance of the entity type. If the property has a valid value, it can be used for the visualization of the instance. If it is not available or not valid the value of the property `ImageUrl` can be used instead.'
            },
            'ImageUrl': {
                '$Nullable': true,
                '@Org.OData.Core.V1.IsURL': true,
                '@Org.OData.Core.V1.Description': 'Image URL for an instance of the entity type. If the property has a valid value, it can be used for the visualization of the instance. If it is not available or not valid the value of the property `TypeImageUrl` can be used instead.'
            },
            'TypeImageUrl': {
                '$Nullable': true,
                '@Org.OData.Core.V1.IsURL': true,
            ...
            'Initials': {
                '$Nullable': true,
                '@com.sap.vocabularies.Common.v1.Experimental': true,
                '@Org.OData.Core.V1.Description': 'Latin letters to be used in case no `Image`, `ImageUrl`, or `TypeImageUrl` is present'
            }
        },
        'Identification': {
            '$Kind': 'Term',
        ...
        'ConnectedFields': {
            ...
            '$AppliesTo': ['EntityType'],
            '@Org.OData.Core.V1.Description': 'Group of semantically connected fields with a representation template and an optional label',
        ...
        'ConnectedFieldsType': {
            ...
            'Template': {
                ...
                '@Org.OData.Core.V1.LongDescription': 'Template variables are identifiers enclosed in curly braces, e.g. `{MaterialName} - {MaterialClassName}`. The `Data` collection assigns values to the template variables.'
            },
            'Data': {
                ...
                '@Org.OData.Core.V1.LongDescription': 'Each template variable used in `Template` must be assigned a value here. The value must be of type [DataFieldAbstract](#DataFieldAbstract)'
            }
        },
        'GeoLocations': {
            '$Kind': 'Term',
        ...
        'Contacts': {
            ...
            '@Org.OData.Core.V1.LongDescription': 'Each collection item MUST reference an annotation of a Communication.Contact',
            '@com.sap.vocabularies.UI.v1.ThingPerspective': true,
        ...
        'DataPoint': {
            ...
            '$AppliesTo': ['EntityType'],
            '@com.sap.vocabularies.UI.v1.ThingPerspective': true,
            '@Org.OData.Core.V1.Description': 'Visualization of a single point of data, typically a number; may also be textual, e.g. a status value'
        },
        'DataPointType': {
            '$Kind': 'ComplexType',
            'Title': {
            ...
            'Criticality': {
                ...
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Service-calculated criticality, alternative to CriticalityCalculation'
            },
            'CriticalityLabels': {
                '$Type': 'Edm.AnnotationPath',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Custom labels for the criticality legend. Annotation path MUST end in UI.CriticalityLabels',
            ...
            'CriticalityCalculation': {
                ...
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Parameters for client-calculated criticality, alternative to Criticality'
            },
            'Trend': {
        ...
        'NumberFormat': {
            ...
            'ScaleFactor': {
                '$Type': 'Edm.Decimal',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Display value in *ScaleFactor* units, e.g. 1000 for k (kilo), 1e6 for M (Mega)'
            },
        ...
        'VisualizationType': {
            ...
            'Rating': 3,
            'Rating@Org.OData.Core.V1.Description': 'Visualize as partially or completely filled stars/hearts/... - requires TargetValue',
            'Donut': 4,
            'Donut@Org.OData.Core.V1.Description': 'Visualize as donut, optionally with missing segment - requires TargetValue',
            'DeltaBulletChart': 5,
        ...
        'CriticalityType': {
            '$Kind': 'EnumType',
            '@Org.OData.Core.V1.Description': 'Criticality of a value or status, represented e.g. via semantic colors (https://experience.sap.com/fiori-design-web/foundation/colors/#semantic-colors)',
            'VeryNegative': -1,
            'VeryNegative@com.sap.vocabularies.Common.v1.Experimental': true,
            'VeryNegative@Org.OData.Core.V1.Description': 'Very negative / dark-red status - risk - out of stock - late',
            'Neutral': 0,
            ...
            'Positive': 3,
            'Positive@Org.OData.Core.V1.Description': 'Positive / green status - completed - available - on track - acceptable',
            'VeryPositive': 4,
        ...
        'CriticalityCalculationType': {
            ...
            '@Org.OData.Core.V1.Description': 'Describes how to calculate the criticality of a value depending on the improvement direction',
            ...
            'ReferenceValue': {
                ...
                '$Nullable': true,
                '@com.sap.vocabularies.Common.v1.Experimental': true,
                '@Org.OData.Core.V1.Description': 'Reference value for the calculation, e.g. number of sales for the last year'
            },
            ...
            'ConstantThresholds': {
                ...
                '@com.sap.vocabularies.Common.v1.Experimental': true,
                '@Org.OData.Core.V1.Description': 'List of thresholds depending on the aggregation level as a set of constant values',
                '@Org.OData.Core.V1.LongDescription': 'Constant thresholds shall only be used in order to refine constant values given for the data point overall (aggregation level with empty collection of property paths), but not if the thresholds are based on other measure elements.'
            }
        },
        ...
        'LevelThresholdsType': {
            ...
            'AggregationLevel': {
                ...
                '@Org.OData.Core.V1.Description': 'An unordered tuple of dimensions, i.e. properties which are intended to be used for grouping in aggregating requests. In analytical UIs, e.g. an analytical chart, the aggregation level typically corresponds to the visible dimensions.'
            }
        },
        'TrendType': {
            '$Kind': 'EnumType',
        ...
        'KPI': {
            ...
            '@com.sap.vocabularies.UI.v1.ThingPerspective': true,
            '@Org.OData.Core.V1.Description': 'A Key Performance Indicator (KPI) bundles a SelectionVariant and a DataPoint, and provides details for progressive disclosure'
        },
        'KPIType': {
            '$Kind': 'ComplexType',
            'ID': {
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Optional identifier to reference this instance from an external context'
            },
            'ShortDescription': {
                '$Nullable': true,
                '@com.sap.vocabularies.Common.v1.Experimental': true,
            ...
            'SelectionVariant': {
                ...
                '@Org.OData.Core.V1.Description': 'Selection variant, either specified inline or referencing another annotation via Path'
            },
            'DataPoint': {
                '$Type': 'com.sap.vocabularies.UI.v1.DataPointType',
                '@Org.OData.Core.V1.Description': 'Data point, either specified inline or referencing another annotation via Path'
            },
            'AdditionalDataPoints': {
                '$Collection': true,
                '$Type': 'com.sap.vocabularies.UI.v1.DataPointType',
                '@Org.OData.Core.V1.Description': 'Additional data points, either specified inline or referencing another annotation via Path',
                '@Org.OData.Core.V1.LongDescription': 'Additional data points are typically related to the main data point and provide complementing information or could be used for comparisons'
            },
            'Detail': {
                '$Type': 'com.sap.vocabularies.UI.v1.KPIDetailType',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Contains information about KPI details, especially drill-down presentations'
            }
        },
        'KPIDetailType': {
            '$Kind': 'ComplexType',
            'DefaultPresentationVariant': {
                ...
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Presentation variant, either specified inline or referencing another annotation via Path'
            },
            'AlternativePresentationVariants': {
                '$Collection': true,
                '$Type': 'com.sap.vocabularies.UI.v1.PresentationVariantType',
                '@Org.OData.Core.V1.Description': 'A list of alternative presentation variants, either specified inline or referencing another annotation via Path'
            },
            'SemanticObject': {
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Name of the Semantic Object. If not specified, use Semantic Object annotated at the property referenced in KPI/DataPoint/Value'
            },
            'Action': {
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Name of the Action on the Semantic Object. If not specified, let user choose which of the available actions to trigger.'
            }
        },
        'Chart': {
            '$Kind': 'Term',
        ...
        'ChartDefinitionType': {
            ...
            'DynamicMeasures': {
                '$Collection': true,
                '$Type': 'Edm.AnnotationPath',
                '@Org.OData.Core.V1.Description': 'Dynamic properties introduced by annotations and used as measures of the chart',
                '@Org.OData.Core.V1.LongDescription': 'If the annotation referenced by an annotation path does not apply to the same collection of entities\n            as the one being visualized according to the `UI.Chart` annotation, the annotation path MUST be silently ignored.',
            ...
            'MeasureAttributes': {
                ...
                '@Org.OData.Core.V1.Description': 'Describes Attributes for Measures. All Measures used in this collection must also be part of the Measures Property.'
            },
            'Dimensions': {
                '$Collection': true,
                '$Type': 'Edm.PropertyPath',
            ...
            'DimensionAttributes': {
                ...
                '@Org.OData.Core.V1.Description': 'Describes Attributes for Dimensions. All Dimensions used in this collection must also be part of the Dimensions Property.'
            },
            'Actions': {
                '$Collection': true,
        ...
        'ChartAxisScalingType': {
            ...
            'FixedScaleMultipleStackedMeasuresBoundaryValues': {
                ...
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Boundary values for fixed scaling of a stacking chart type with multiple measures'
            }
        },
        'ChartAxisScaleBehaviorType': {
            ...
            'FixedScale': 1,
            'FixedScale@Org.OData.Core.V1.Description': 'Fixed minimum and maximum values are applied, which are derived from the @UI.MeasureAttributes.DataPoint/MinimumValue and .../MaximumValue annotation by default.\n        For stacking chart types with multiple measures, they are taken from ChartAxisScalingType/FixedScaleMultipleStackedMeasuresBoundaryValues.\n            '
        },
        ...
        'ChartAxisAutoScaleDataScopeType': {
            '$Kind': 'EnumType',
            'DataSet': 0,
            'DataSet@Org.OData.Core.V1.Description': 'Minimum and maximum axes values are determined from the entire data set',
            'VisibleData': 1,
            'VisibleData@Org.OData.Core.V1.Description': 'Minimum and maximum axes values are determined from the currently visible data. Scrolling will change the scale.'
        },
        ...
        'ChartDimensionAttributeType': {
            ...
            'HierarchyLevel': {
                ...
                '$Nullable': true,
                '@com.sap.vocabularies.Common.v1.Experimental': true,
                '@Org.OData.Core.V1.Description': 'For a dimension with a hierarchy, members are selected from this level. The root node of the hierarchy is at level 0.'
            },
            'ValuesForSequentialColorLevels': {
                '$Collection': true,
                '@com.sap.vocabularies.Common.v1.Experimental': true,
                '@Org.OData.Core.V1.Description': 'All values in this collection should be assigned to levels of the same color.'
            },
            'EmphasizedValues': {
                '$Collection': true,
                '@com.sap.vocabularies.Common.v1.Experimental': true,
            ...
            'EmphasisLabels': {
                ...
                '$Nullable': true,
                '@com.sap.vocabularies.Common.v1.Experimental': true,
                '@Org.OData.Core.V1.Description': 'Assign a label to values with an emphasized representation. This is required, if more than one emphasized value has been specified.'
            }
        },
        'ChartMeasureAttributeType': {
            ...
            'DynamicMeasure': {
                '$Type': 'Edm.AnnotationPath',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Dynamic property introduced by an annotation and used as a measure in a chart',
                '@Org.OData.Core.V1.LongDescription': 'If the annotation referenced by an annotation path does not apply to the same collection of entities\n            as the one being visualized according to the `UI.Chart` annotation, the annotation path MUST be silently ignored.',
                '@Org.OData.Validation.V1.AllowedTerms': [
                    'com.sap.vocabularies.Analytics.v1.AggregatedProperty',
                    'Org.OData.Aggregation.V1.CustomAggregate'
            ...
            'DataPoint': {
                '$Type': 'Edm.AnnotationPath',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': "Annotation path MUST end in @UI.DataPoint and the data point's Value MUST be the same property as in Measure",
            ...
            'UseSequentialColorLevels': {
                ...
                '$DefaultValue': false,
                '@com.sap.vocabularies.Common.v1.Experimental': true,
                '@Org.OData.Core.V1.Description': 'All measures for which this setting is true should be assigned to levels of the same color.'
            }
        },
        ...
        'EmphasisLabelType': {
            '$Kind': 'ComplexType',
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'Assigns a label to the set of emphasized values and optionally also for non-emphasized values. This information can be used for semantic coloring.',
        ...
        'ValueCriticality': {
            ...
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'Assign criticalities to primitive values. This information can be used for semantic coloring.'
        },
        'ValueCriticalityType': {
            '$Kind': 'ComplexType',
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'Assigns a fixed criticality to a primitive value. This information can be used for semantic coloring.',
            'Value': {
                '$Type': 'Edm.PrimitiveType',
                '$Nullable': true,
        ...
        'CriticalityLabelType': {
            '$Kind': 'ComplexType',
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'Assigns a label to a criticality. This information can be used for semantic coloring.',
            'Criticality': {
                '$Type': 'com.sap.vocabularies.UI.v1.CriticalityType'
            },
            'Label': {
        ...
        'SelectionFields': {
            ...
            '$AppliesTo': ['EntityType'],
            '@com.sap.vocabularies.UI.v1.ThingPerspective': true,
            '@Org.OData.Core.V1.Description': 'Properties that might be relevant for filtering a collection of entities of this type'
        },
        'Facets': {
            '$Kind': 'Term',
            '$Collection': true,
        ...
        'FilterFacets': {
            ...
            '$AppliesTo': ['EntityType'],
            '@Org.OData.Core.V1.Description': 'Facets that reference UI.FieldGroup annotations to group filterable fields'
        },
        'Facet': {
            '$Kind': 'ComplexType',
            '$Abstract': true,
            ...
            'ID': {
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Unique identifier of a facet. ID should be stable, as long as the perceived semantics of the facet is unchanged.'
            }
        },
        'CollectionFacet': {
            '$Kind': 'ComplexType',
            ...
            'Facets': {
                '$Collection': true,
                '$Type': 'com.sap.vocabularies.UI.v1.Facet',
                '@Org.OData.Core.V1.Description': 'Nested facets. An empty collection may be used as a placeholder for content added via extension points.'
            }
        },
        'ReferenceFacet': {
            '$Kind': 'ComplexType',
            ...
            'Target': {
                '$Type': 'Edm.AnnotationPath',
                '@Org.OData.Core.V1.Description': 'Referenced information: Communication.Contact, Communication.Address, or a term that is tagged with UI.ThingPerspective, e.g. UI.StatusInfo, UI.LineItem, UI.Identification, UI.FieldGroup, UI.Badge',
                '@Org.OData.Validation.V1.AllowedTerms': [
        ...
        'SelectionPresentationVariant': {
            ...
            '$AppliesTo': ['EntitySet', 'EntityType'],
            '@com.sap.vocabularies.UI.v1.ThingPerspective': true,
            '@Org.OData.Core.V1.Description': 'A SelectionPresentationVariant bundles a Selection Variant and a Presentation Variant'
        },
        'SelectionPresentationVariantType': {
            '$Kind': 'ComplexType',
            'ID': {
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Optional identifier to reference this variant from an external context'
            },
            'Text': {
                '$Nullable': true,
                '@Org.OData.Core.V1.IsLanguageDependent': true,
        ...
        'PresentationVariant': {
            ...
            '$AppliesTo': ['EntitySet', 'EntityType'],
            '@com.sap.vocabularies.UI.v1.ThingPerspective': true,
            '@Org.OData.Core.V1.Description': 'Defines how the result of a queried collection of entities is shaped and how this result is displayed'
        },
        'PresentationVariantType': {
            ...
            'SortOrder': {
                ...
                '@Org.OData.Core.V1.Description': 'Collection can be provided inline or as a reference to a Common.SortOrder annotation via Path'
            },
            'GroupBy': {
                '$Collection': true,
                '$Type': 'Edm.PropertyPath',
                '@Org.OData.Core.V1.Description': 'Sequence of groupable properties p1, p2, ... defining how the result is composed of instances representing groups,\n            one for each combination of value properties in the queried collection. The sequence specifies a certain level\n            of aggregation for the queried collection, and every group instance will provide aggregated values for\n            properties that are aggregatable. Moreover, the series of sub-sequences (p1), (p1, p2), ... forms a leveled hierarchy,\n            which may become relevant in combination with `InitialExpansionLevel`.'
            },
            'TotalBy': {
                '$Collection': true,
                '$Type': 'Edm.PropertyPath',
                '@Org.OData.Core.V1.Description': 'Sub-sequence q1, q2, ... of properties p1, p2, ... specified in GroupBy. With this, additional levels of aggregation\n            are requested in addition to the most granular level defined by GroupBy: Every element in the series of sub-sequences\n            (q1), (q1, q2), ... introduces an additional aggregation level included in the result.'
            },
            'Total': {
                '$Collection': true,
                '$Type': 'Edm.PropertyPath',
                '@com.sap.vocabularies.Common.v1.PrimitivePropertyPath': true,
                '@Org.OData.Core.V1.Description': 'Aggregatable properties for which aggregated values should be provided for the additional aggregation levels specified in TotalBy.'
            },
            'DynamicTotal': {
                '$Collection': true,
                '$Type': 'Edm.AnnotationPath',
                '@Org.OData.Core.V1.Description': 'Dynamic properties introduced by annotations for which aggregated values should be provided for the additional aggregation levels specified in TotalBy',
            ...
            'RequestAtLeast': {
                '$Collection': true,
                '$Type': 'Edm.PropertyPath',
                '@Org.OData.Core.V1.Description': 'Properties that should always be included in the result of the queried collection',
                '@Org.OData.Core.V1.LongDescription': 'Properties in `RequestAtLeast` must occur either in the `$select` clause of an OData request\n            or among the grouping properties in an `$apply=groupby((grouping properties),...)` clause of an\n            aggregating OData request.'
            },
            'SelectionFields': {
                '$Collection': true,
                '$Type': 'Edm.PropertyPath',
                '@com.sap.vocabularies.Common.v1.Experimental': true,
                '@Org.OData.Core.V1.Description': 'Properties that should be presented for filtering a collection of entities.\n            Can be provided inline or as a reference to a `UI.SelectionFields` annotation via Path.'
            }
        },
        'SelectionVariant': {
            '$Kind': 'Term',
            '$Type': 'com.sap.vocabularies.UI.v1.SelectionVariantType',
            '$AppliesTo': ['EntitySet', 'EntityType'],
            '@Org.OData.Core.V1.Description': 'A SelectionVariant denotes a combination of parameters and filters to query the annotated entity set'
        },
        'SelectionVariantType': {
            '$Kind': 'ComplexType',
            'ID': {
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': ' May contain identifier to reference this instance from an external context'
            },
            'Text': {
                '$Nullable': true,
                '@Org.OData.Core.V1.IsLanguageDependent': true,
        ...
        'SelectOptionType': {
            ...
            '@Org.OData.Core.V1.LongDescription': 'Exactly one of `PropertyName` and `DynamicPropertyName` must be present',
            'PropertyName': {
                '$Type': 'Edm.PropertyPath',
                '$Nullable': true,
                '@com.sap.vocabularies.Common.v1.PrimitivePropertyPath': true,
            ...
            'DynamicPropertyName': {
                '$Type': 'Edm.AnnotationPath',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Dynamic property introduced by annotations for which value ranges are specified',
        ...
        'SelectionRangeType': {
            '$Kind': 'ComplexType',
            '@Org.OData.Core.V1.Description': 'Value range. If the range option only requires a single value, the value must be in the property Low',
            'Sign': {
        ...
        'IsSummary': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Record'],
            '@Org.OData.Core.V1.Description': 'This Facet and all included Facets are the summary of the thing. At most one Facet of a thing can be tagged with this term',
        ...
        'PartOfPreview': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Record'],
            '@Org.OData.Core.V1.Description': 'This record and all included structural elements are part of the Thing preview',
        ...
        'Map': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Record'],
            '@Org.OData.Core.V1.Description': 'Target MUST reference a UI.GeoLocation, Communication.Address or a collection of these',
        ...
        'IsImageURL': {
            ...
            '@Org.OData.Core.V1.Description': 'Properties and terms annotated with this term MUST contain a valid URL referencing an resource with a MIME type image',
        ...
        'IsImage': {
            ...
            '$AppliesTo': ['Property', 'EntityType'],
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'Properties annotated with this term MUST be a stream property annotated with a MIME type image. Entity types annotated with this term MUST be a media entity type annotated with a MIME type image.',
        ...
        'MultiLineText': {
            ...
            '@Org.OData.Core.V1.Description': 'Properties and parameters annotated with this annotation should be rendered as multi-line text (e.g. text area)',
            '@Org.OData.Core.V1.RequiresType': 'Edm.String'
        },
        'Placeholder': {
            '$Kind': 'Term',
            '$AppliesTo': ['Property', 'Parameter'],
            '@Org.OData.Core.V1.Description': 'A short, human-readable text that gives a hint or an example to help the user with data entry',
            '@Org.OData.Core.V1.IsLanguageDependent': true
        },
        'InputMask': {
            '$Kind': 'Term',
            ...
            '$AppliesTo': ['Property', 'Parameter'],
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'Properties or parameters annotated with this term will get a mask in edit mode',
            '@Org.OData.Core.V1.LongDescription': 'Input masks improve readability and help to enter data correctly. \nSo, masks can be especially useful for input fields that have a fixed pattern, e.g. DUNS numbers or similar. \n[Here](../examples/UI.InputMask-sample.xml) you can find an example for this annotation'
        },
        'InputMaskType': {
            '$Kind': 'ComplexType',
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            ...
            'Placeholder': {
                '$MaxLength': 1,
                '$DefaultValue': '_',
                '@Org.OData.Core.V1.Description': 'A single character symbol to be shown where the user can type a character'
            },
            'Rules': {
                '$Collection': true,
                ...
                '@Org.OData.Core.V1.LongDescription': "The following rules are defined as default and don't need to be listed here: * = ., C = [a-zA-Z], 9 = [0-9]"
            }
        },
        'InputMaskRuleType': {
            '$Kind': 'ComplexType',
            ...
            'MaskSymbol': {
                '$MaxLength': 1,
                '@Org.OData.Core.V1.Description': 'A symbol in the mask that stands for a regular expression which must be matched by the user input in every position where this symbol occurs'
            },
            'RegExp': {
        ...
        'TextArrangementType': {
            ...
            'TextLast': 1,
            'TextLast@Org.OData.Core.V1.Description': 'Code/ID is first, followed by the text (e.g. separated by a dash)',
            'TextSeparate': 2,
            'TextSeparate@Org.OData.Core.V1.Description': 'Code/ID and text are represented separately (code/ID will be shown and text can be visualized in a separate place)',
            'TextOnly': 3,
        ...
        'NoteType': {
            ...
            'Title': {
                ...
                '@Org.OData.Core.V1.LongDescription': 'The title of a note is hidden with an annotation `@UI.Note/Title/@UI.Hidden`, not with\n            an annotation on the property targeted by `@UI.Note/Title`.',
        ...
        'Hidden': {
            ...
            '@Org.OData.Core.V1.Description': 'Properties or facets (see UI.Facet) annotated with this term will not be rendered if the annotation evaluates to true.',
            '@Org.OData.Core.V1.LongDescription': 'Hidden properties usually carry technical information that is used for application control and is of no direct interest to end users.\n          The annotation value may be an expression to dynamically hide or render the annotated feature. If a navigation property is annotated with `Hidden` true, all subsequent parts are hidden - independent of their own potential `Hidden` annotations.'
        },
        'IsCopyAction': {
            '$Kind': 'Term',
            '$Type': 'Org.OData.Core.V1.Tag',
            ...
            '@Org.OData.Core.V1.Description': 'The annotated [`DataFieldForAction`](#DataFieldForAction) record references an action that deep-copies an instance of the annotated entity type',
            '@Org.OData.Core.V1.LongDescription': 'The referenced action MUST be bound to the annotated entity type and MUST create a new instance of the same entity type as a deep copy of the bound instance.\nUpon successful completion, the response MUST contain a `Location` header that contains the edit URL or read URL of the created entity,\nand the response MUST be either `201 Created` and a representation of the created entity,\nor `204 No Content` if the request included a `Prefer` header with a value of `return=minimal` and did not include the system query options `$select` and `$expand`.'
        },
        'CreateHidden': {
            '$Kind': 'Term',
            '$Type': 'Org.OData.Core.V1.Tag',
            '$AppliesTo': ['EntitySet', 'EntityType'],
            '@Org.OData.Core.V1.Description': 'EntitySets annotated with this term can control the visibility of the Create operation dynamically',
            '@Org.OData.Core.V1.LongDescription': 'The annotation value should be a path to another property from a related entity.'
        },
        'UpdateHidden': {
            '$Kind': 'Term',
            '$Type': 'Org.OData.Core.V1.Tag',
            '$AppliesTo': ['EntitySet', 'EntityType'],
            '@Org.OData.Core.V1.Description': 'EntitySets annotated with this term can control the visibility of the Edit/Save operation dynamically',
            '@Org.OData.Core.V1.LongDescription': 'The annotation value should be a path to another property from the same or a related entity.'
        },
        'DeleteHidden': {
            '$Kind': 'Term',
            '$Type': 'Org.OData.Core.V1.Tag',
            '$AppliesTo': ['EntitySet', 'EntityType'],
            '@Org.OData.Core.V1.Description': 'EntitySets annotated with this term can control the visibility of the Delete operation dynamically',
            '@Org.OData.Core.V1.LongDescription': 'The annotation value should be a path to another property from the same or a related entity.'
        },
        'HiddenFilter': {
            '$Kind': 'Term',
        ...
        'AdaptationHidden': {
            ...
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': "Properties or entities annotated with this term can't be used for UI adaptation/configuration/personalization",
            '@Org.OData.Core.V1.LongDescription': 'The tagged elements can only be used in UI based on metadata, annnotations or code.'
        },
        'DataFieldDefault': {
            '$Kind': 'Term',
            '$Type': 'com.sap.vocabularies.UI.v1.DataFieldAbstract',
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'Default representation of a property as a datafield, e.g. when the property is added as a table column or form field via personalization',
            '@Org.OData.Core.V1.LongDescription': 'Only concrete subtypes of [DataFieldAbstract](#DataFieldAbstract) can be used for a DataFieldDefault. For type [DataField](#DataField) and its subtypes the annotation target SHOULD be the same property that is referenced via a path expression in the `Value` of the datafield.'
        },
        'DataFieldAbstract': {
            '$Kind': 'ComplexType',
            '$Abstract': true,
            '@Org.OData.Core.V1.Description': 'Elementary building block that represents a piece of data and/or allows triggering an action',
            '@Org.OData.Core.V1.LongDescription': 'By using the applicable terms UI.Hidden, UI.Importance or HTML5.CssDefaults, the visibility, the importance and\n          and the default css settings (as the width) of the data field can be influenced. ',
            '@Org.OData.Validation.V1.ApplicableTerms': [
                'com.sap.vocabularies.UI.v1.Hidden',
        ...
        'CriticalityRepresentationType': {
            ...
            'WithoutIcon': 1,
            'WithoutIcon@Org.OData.Core.V1.Description': 'Criticality is represented without icon, e.g. only via text color',
            'OnlyIcon': 2,
        ...
        'DataFieldForAnnotation': {
            ...
            'Target': {
                '$Type': 'Edm.AnnotationPath',
                '@Org.OData.Core.V1.Description': 'Target MUST reference an annotation of terms Communication.Contact, Communication.Address, UI.DataPoint, UI.Chart, UI.FieldGroup, or UI.ConnectedFields',
                '@Org.OData.Validation.V1.AllowedTerms': [
                    'com.sap.vocabularies.Communication.v1.Address',
                    'com.sap.vocabularies.Communication.v1.Contact',
                    'com.sap.vocabularies.UI.v1.Chart',
        ...
        'DataFieldForActionAbstract': {
            ...
            'Inline': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': false,
                '@Org.OData.Core.V1.Description': 'Action should be placed close to (or even inside) the visualized term'
            },
            'Determining': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': false,
                '@Org.OData.Core.V1.Description': 'Determines whether the action completes a process step (e.g. approve, reject).'
            }
        },
        'DataFieldForAction': {
            '$Kind': 'ComplexType',
            ...
            '@Org.OData.Core.V1.LongDescription': 'The action is NOT tied to a data value (in contrast to [DataFieldWithAction](#DataFieldWithAction)).',
            'Action': {
            ...
            'InvocationGrouping': {
                ...
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Expresses how invocations of this action on multiple instances should be grouped'
            }
        },
        ...
        'DataFieldForIntentBasedNavigation': {
            ...
            '@Org.OData.Core.V1.LongDescription': 'The navigation intent is expressed as a Semantic Object and optionally an Action on that object.\n\nIt is NOT tied to a data value (in contrast to [DataFieldWithIntentBasedNavigation](#DataFieldWithIntentBasedNavigation)).',
            'SemanticObject': {
            ...
            'NavigationAvailable': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': true,
                '@Org.OData.Core.V1.Description': 'The navigation intent is for that user with the selected context and parameters available'
            },
            'RequiresContext': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': false,
                '@Org.OData.Core.V1.Description': 'Determines whether  a context needs to be passed to the target of this navigation.'
            },
            'Mapping': {
                '$Collection': true,
                '$Type': 'com.sap.vocabularies.Common.v1.SemanticObjectMappingType',
                '@Org.OData.Core.V1.Description': 'Maps properties of the annotated entity type to properties of the Semantic Object'
            }
        },
        'DataFieldForActionGroup': {
            ...
            'Actions': {
                '$Collection': true,
                '$Type': 'com.sap.vocabularies.UI.v1.DataFieldForActionAbstract',
                '@Org.OData.Core.V1.Description': 'Collection of data fields that refer to actions or intent based navigations'
            }
        },
        'DataField': {
            '$Kind': 'ComplexType',
        ...
        'DataFieldWithAction': {
            ...
            '@Org.OData.Core.V1.LongDescription': 'The action is tied to a data value. This is in contrast to [DataFieldForAction](#DataFieldForAction) which is not tied to a specific data value.',
            'Value': {
                '$Type': 'Edm.PrimitiveType'
            },
            'Action': {
        ...
        'DataFieldWithNavigationPath': {
            ...
            'Target': {
                ...
                '@Org.OData.Core.V1.Description': 'Contains either a navigation property or a term cast, where term is of type Edm.EntityType or a concrete entity type or a collection of these types'
            }
        },
        'DataFieldWithUrl': {
            '$Kind': 'ComplexType',
        ...
        'DataFieldWithActionGroup': {
            ...
            'Actions': {
                '$Collection': true,
                '$Type': 'com.sap.vocabularies.UI.v1.DataField',
                '@Org.OData.Core.V1.Description': 'Collection of data fields that are either [DataFieldWithAction](#DataFieldWithAction), [DataFieldWithIntentBasedNavigation](#DataFieldWithIntentBasedNavigation), [DataFieldWithNavigationPath](#DataFieldWithNavigationPath), or [DataFieldWithUrl](#DataFieldWithUrl)'
            }
        },
        'Criticality': {
            '$Kind': 'Term',
        ...
        'CriticalityCalculation': {
            ...
            '$Type': 'com.sap.vocabularies.UI.v1.CriticalityCalculationType',
            '$AppliesTo': ['Annotation'],
            '@Org.OData.Core.V1.Description': 'Parameters for client-calculated criticality, alternative to UI.Criticality'
        },
        'Emphasized': {
            '$Kind': 'Term',
            '$Type': 'Org.OData.Core.V1.Tag',
            ...
            '@Org.OData.Core.V1.LongDescription': "The usage of a property or operation should be highlighted as it's of special interest for the end user"
        },
        'OrderBy': {
            '$Kind': 'Term',
            '$Type': 'Edm.PropertyPath',
            ...
            '@Org.OData.Core.V1.LongDescription': 'Example: annotated property `SizeCode` has string values XS, S, M, L, XL, referenced property SizeOrder has numeric values -2, -1, 0, 1, 2. Numeric ordering by SizeOrder will be more understandable than lexicographic ordering by SizeCode.'
        },
        'ParameterDefaultValue': {
            ...
            '@Org.OData.Core.V1.LongDescription': 'For unbound actions the default value can either be a constant expression, or a dynamic expression using absolute paths, e.g. singletons or function import results.\n            Whereas for bound actions the bound entity and its properties and associated properties can be used as default values'
        },
        'RecommendationState': {
            '$Kind': 'Term',
            ...
            '@Org.OData.Core.V1.LongDescription': 'Intelligent systems can help users by recommending input the user may "prefer".'
        },
        'RecommendationStateType': {
            '$Kind': 'TypeDefinition',
            '$UnderlyingType': 'Edm.Byte',
            '@Org.OData.Core.V1.Description': 'Indicates whether a field contains or has a recommended value',
            '@Org.OData.Core.V1.LongDescription': 'Editable fields for which a recommendation has been pre-filled or that have recommendations that differ from existing human input need to be highlighted.',
        ...
        'RecommendationList': {
            ...
            '$AppliesTo': ['Property', 'Parameter'],
            '@Org.OData.Core.V1.Description': 'Specifies how to get a list of recommended values for a property or parameter',
            '@Org.OData.Core.V1.LongDescription': 'Intelligent systems can help users by recommending input the user may "prefer".'
        },
        'RecommendationListType': {
            '$Kind': 'ComplexType',
            '@Org.OData.Core.V1.Description': 'Reference to a recommendation list',
            '@Org.OData.Core.V1.LongDescription': 'A recommendation consists of one or more values for editable fields plus a rank between 0.0 and 9.9, with 9.9 being the best recommendation.',
            'CollectionPath': {
                '@Org.OData.Core.V1.Description': 'Resource path of a collection of recommended values'
            },
            'RankProperty': {
                '@Org.OData.Core.V1.Description': 'Name of the property within the collection of recommended values that describes the rank of the recommendation'
            },
            'Binding': {
                '$Collection': true,
        ...
        'RecommendationBinding': {
            ...
            'ValueListProperty': {
                '@Org.OData.Core.V1.Description': 'Path to property in the collection of recommended values. Format is identical to PropertyPath annotations.'
            }
        },
        'ExcludeFromNavigationContext': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'The contents of this property must not be propagated to the app-to-app navigation context'
        },
