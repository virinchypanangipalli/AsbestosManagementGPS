...
exports.default = {
    ...
    'com.sap.vocabularies.Analytics.v1': {
        ...
        'Measure': {
            ...
            '@Org.OData.Core.V1.Description': 'A property holding the numeric value of a measure in an analytical context'
        },
        'AccumulativeMeasure': {
            '$Kind': 'Term',
            '$Type': 'Org.OData.Core.V1.Tag',
            ...
            '@Org.OData.Core.V1.Description': 'The measure has non-negative and additive values; it can be used in whole-part charts, e.g. the Donut'
        },
        'RolledUpPropertyCount': {
            '$Kind': 'Term',
            '$Type': 'Edm.Int16',
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'Number of properties in the entity instance that have been aggregated away'
        },
        'DrillURL': {
            '$Kind': 'Term',
        ...
        'PlanningAction': {
            ...
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': ' Processes or generates plan data. Its logic may have side-effects on entity sets.\n          '
        },
        'AggregatedProperties': {
            ...
            '@Org.OData.Core.V1.Description': 'Dynamic properties for aggregate expressions with specified aggregation method defined on the annotated entity type.',
        ...
        'AggregatedProperty': {
            ...
            '$Type': 'com.sap.vocabularies.Analytics.v1.AggregatedPropertyType',
            '$AppliesTo': ['EntityType'],
            '@Org.OData.Core.V1.Description': 'Dynamic property for aggregate expression with specified aggregation method defined on the annotated entity type.'
        },
        ...
        'AnalyticalContextType': {
            ...
            'DynamicProperty': {
                ...
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Dynamic property introduced by annotations that is part of the analytical context',
        ...
        '$Annotations': {
            'Org.OData.Aggregation.V1.CustomAggregate': {
                '@Org.OData.Validation.V1.ApplicableTerms@Org.OData.Core.V1.Description': 'Adding a list of other terms that can be annotated to it.',
                '@Org.OData.Validation.V1.ApplicableTerms': ['com.sap.vocabularies.Common.v1.Label']
            }
        }
    }
};
//# sourceMappingURL=com.sap.vocabularies.Analytics.v1.js.map