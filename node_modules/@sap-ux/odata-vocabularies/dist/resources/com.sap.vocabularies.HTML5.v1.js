...
exports.default = {
    ...
    'com.sap.vocabularies.HTML5.v1': {
        ...
        'CssDefaultsType': {
            ...
            'width': {
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'css: width, see https://www.w3.org/TR/CSS21/visudet.html#propdef-width',
        ...
        'LinkTarget': {
            ...
            '@Org.OData.Core.V1.Description': 'Where to open a link for the annotated [URL](https://oasis-tcs.github.io/odata-vocabularies/vocabularies/Org.OData.Core.V1.html#IsURL)',
            '@Org.OData.Core.V1.LongDescription': 'When the UI contains a link to the URL, it shall open as specified by this annotation.\n          This can be achieved, for example, by giving the UI5 `sap.m.Link` element a corresponding `target` property.\n          Applicability of this term is governed by [`Validation.ApplicableTerms`](https://oasis-tcs.github.io/odata-vocabularies/vocabularies/Org.OData.Validation.V1.html#ApplicableTerms) annotations.'
        },
        'LinkTargetType': {
            '$Kind': 'TypeDefinition',
            '$UnderlyingType': 'Edm.String',
            '@Org.OData.Core.V1.Description': 'The values are interpreted like the [target attribute](https://html.spec.whatwg.org/multipage/links.html#attr-hyperlink-target) in HTML',
...
//# sourceMappingURL=com.sap.vocabularies.HTML5.v1.js.map