...
exports.default = {
    ...
    'Org.OData.Measures.V1': {
        ...
        'Scale': {
            ...
            '$Type': 'Edm.Byte',
            '$AppliesTo': ['Parameter', 'Property'],
            '@Org.OData.Core.V1.Description': 'The number of significant decimal places in the scale part (less than or equal to the number declared in the Scale facet)',
            '@Org.OData.Core.V1.RequiresType': 'Edm.Decimal'
        },
        'Unit': {
            '$Kind': 'Term',
            '$AppliesTo': ['Parameter', 'Property'],
            '@Org.OData.Core.V1.Description': 'The unit of measure for this measured quantity, e.g. cm for centimeters or % for percentages'
        },
        'UNECEUnit': {
            '$Kind': 'Term',
            '$AppliesTo': ['Parameter', 'Property'],
            '@Org.OData.Core.V1.Description': 'The unit of measure for this measured quantity, according to the [UN/CEFACT Recommendation 20](http://tfig.unece.org/contents/recommendation-20.htm)'
        },
        'DurationGranularity': {
            '$Kind': 'Term',
            ...
            '@Org.OData.Core.V1.LongDescription': 'Absence of this annotation means a granularity of seconds with sub-seconds according to the Precision facet.',
...
//# sourceMappingURL=Org.OData.Measures.V1.js.map