    ...
    'Org.OData.Validation.V1': {
        ...
        'ConstraintType': {
            ...
            'FailureMessage': {
                ...
                '@Org.OData.Core.V1.Description': 'Human-readable message that can be shown to end users if the constraint is not fulfilled'
            },
            'Condition': {
                '$Type': 'Edm.Boolean',
                '@Org.OData.Core.V1.Description': 'Value MUST be a dynamic expression that evaluates to true if and only if the constraint is fulfilled'
            }
        },
        'ItemsOf': {
            '$Kind': 'Term',
            ...
            '@Org.OData.Core.V1.Description': 'A list of constraints describing that entities related via one navigation property MUST also be related via another, collection-valued navigation property. The same `path` value MUST NOT occur more than once.',
            '@Org.OData.Core.V1.LongDescription': 'Example: entity type `Customer` has navigation properties `AllOrders`, `OpenOrders`, and `ClosedOrders`. \nThe term allows to express that items of `OpenOrders` and `ClosedOrders` are also items of the `AllOrders` navigation property,\neven though they are defined in an `Orders` entity set.'
        },
        'ItemsOfType': {
            '$Kind': 'ComplexType',
            '@Org.OData.Core.V1.Description': 'Entities related via the single- or collection-valued navigation property identified by `path` are also related via the collection-valued navigation property identified by `target`.',
            'path': {
        ...
        'OpenPropertyTypeConstraint': {
            ...
            '@Org.OData.Core.V1.Description': 'Dynamic properties added to the annotated open structured type are restricted to the listed types.'
        },
        ...
        'AllowedTerms': {
            ...
            '@Org.OData.Core.V1.Description': 'Annotate a term of type Edm.AnnotationPath, or a property of type Edm.AnnotationPath that is used within a structured term, to restrict the terms that can be targeted by the path.',
            '@Org.OData.Core.V1.LongDescription': 'The annotation path expression is intended to end in a path segment with one of the listed terms. For forward compatibility, clients should be prepared for the annotation to reference terms besides those listed.',
        ...
        'ApplicableTerms': {
            ...
            '$Collection': true,
            '$Type': 'Org.OData.Core.V1.QualifiedTermName',
            '@Org.OData.Core.V1.Description': 'Names of specific terms that are applicable and may be applied in the current context. This annotation does not restrict the use of other terms.'
        },
        'MaxItems': {
            '$Kind': 'Term',
            '$Type': 'Edm.Int64',
            '$AppliesTo': ['Collection'],
            '@Org.OData.Core.V1.Description': 'The annotated collection must have at most the specified number of items.'
        },
        'MinItems': {
            '$Kind': 'Term',
            '$Type': 'Edm.Int64',
            '$AppliesTo': ['Collection'],
            '@Org.OData.Core.V1.Description': 'The annotated collection must have at least the specified number of items.'
        }
    }
};
//# sourceMappingURL=Org.OData.Validation.V1.js.map