...
exports.default = {
    ...
    'com.sap.vocabularies.DirectEdit.v1': {
        ...
        'SideEffectsType': {
            '$Kind': 'ComplexType',
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.LongDescription': 'After a change to a property whose path is contained in `Triggers`, the client should pass the entity with the changed property to the `CalculationFunction` and receive the entity with all changes that happen as side effects of the given change.',
            'Triggers': {
                '$Collection': true,
                '@Org.OData.Core.V1.Description': 'List of paths to the properties whose changes should trigger the side effects calculation.',
...
//# sourceMappingURL=com.sap.vocabularies.DirectEdit.v1.js.map