...
exports.default = {
    ...
    'Org.OData.JSON.V1': {
        ...
        'Schema': {
            ...
            '@Org.OData.Core.V1.Description': 'The JSON Schema for JSON values of the annotated media entity type, property, parameter, return type, term, or type definition',
            '@Org.OData.Core.V1.LongDescription': 'The schema can be a schema reference, i.e. `{"$ref":"url/of/schemafile#/path/to/schema/within/schemafile"}`'
        },
        'JSON': {
            '$Kind': 'TypeDefinition',
...
//# sourceMappingURL=Org.OData.JSON.V1.js.map