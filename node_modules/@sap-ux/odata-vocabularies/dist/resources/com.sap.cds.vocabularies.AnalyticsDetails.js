...
exports.default = {
    'com.sap.cds.vocabularies.AnalyticsDetails': {
        ...
        'exceptionAggregationSteps': {
            ...
            '@Org.OData.Core.V1.Description': '(CDS annotation) Used to define different (to the default aggregation) aggregation behavior for specified elements. In general there can be multiple elements in which a measure has to be aggregated differently. Therefore a list of ExceptionAggregationSteps can be assigned.'
        },
        ...
        'variable': {
            ...
            '@Org.OData.Core.V1.Description': '(CDS annotation) Annotation for a parameter, only supported in analytics. With this annotation a parameter can become a variable which represents an interval or a range. It can also become optional or can represent multiple values.'
        },
        'VariableType': {
            '$Kind': 'ComplexType',
            ...
            'defaultRanges': {
                ...
                '@Org.OData.Core.V1.Description': 'Specifies a complex default filter in combination with the selectionType #RANGE (or #SINGLE / #INTERVAL in combinaton with "multipleSelections: true"). The default value ranges must comply to the combination of selectionType and multipleSelections.'
            },
            'selectionType': {
                '$Nullable': true,
...
//# sourceMappingURL=com.sap.cds.vocabularies.AnalyticsDetails.js.map