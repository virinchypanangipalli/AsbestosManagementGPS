...
exports.default = {
    ...
    'com.sap.vocabularies.CodeList.v1': {
        ...
        'ExternalCode': {
            ...
            '@Org.OData.Core.V1.LongDescription': 'The annotated property contains values that are not intended for visualization and should thus stay hidden from end-users. Instead the values of the referenced properties are used for visualization.'
        },
        'IsConfigurationDeprecationCode': {
            ...
            '@Org.OData.Core.V1.LongDescription': 'The Configuration Deprecation Code indicates whether a code list value is valid (deprecation code is empty/space), deprecated (deprecation code `W`), or revoked (deprecation code `E`). '
        }
    }
};
//# sourceMappingURL=com.sap.vocabularies.CodeList.v1.js.map