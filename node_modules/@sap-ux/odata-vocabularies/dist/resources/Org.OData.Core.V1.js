...
exports.default = {
    ...
    'Org.OData.Core.V1': {
        ...
        'Link': {
            '$Kind': 'ComplexType',
            '@Org.OData.Core.V1.Description': 'The Link term is inspired by the `atom:link` element, see [RFC4287](https://tools.ietf.org/html/rfc4287#section-4.2.7), and the `Link` HTTP header, see [RFC5988](https://tools.ietf.org/html/rfc5988)',
            'rel': {
                '@Org.OData.Core.V1.Description': 'Link relation type, see [IANA Link Relations](http://www.iana.org/assignments/link-relations/link-relations.xhtml)'
            },
            'href': {
        ...
        'ResourceExceptionType': {
            ...
            'retryLink': {
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'A GET request to this URL retries retrieving the problematic instance',
                '@Org.OData.Core.V1.IsURL': true
            }
        },
        'DataModificationException': {
            ...
            '@Org.OData.Core.V1.Description': 'A modification operation failed on the annotated instance or collection within a success payload'
        },
        'DataModificationExceptionType': {
            ...
            'responseCode': {
                '$Type': 'Edm.Int16',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Response code of the failed operation, e.g. 424 for a failed dependency',
        ...
        'AppliesViaContainer': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Term'],
            '@Org.OData.Core.V1.Description': 'The target path of an annotation with the tagged term MUST start with an entity container or the annotation MUST be embedded within an entity container, entity set or singleton',
            '@Org.OData.Core.V1.LongDescription': 'Services MAY additionally annotate a container-independent model element (entity type, property, navigation property) if allowed by the `AppliesTo` property of the term\n          and the annotation applies to all uses of that model element.'
        },
        'ResourcePath': {
            '$Kind': 'Term',
        ...
        'Immutable': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'A value for this non-key property can be provided by the client on insert and remains unchanged on update'
        },
        'Computed': {
            '$Kind': 'Term',
            '$Type': 'Org.OData.Core.V1.Tag',
        ...
        'ComputedDefaultValue': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'A value for this property can be provided by the client on insert and update. If no value is provided on insert, a non-static default value is generated'
        },
        'IsURL': {
            '$Kind': 'Term',
            '$Type': 'Org.OData.Core.V1.Tag',
        ...
        'AcceptableMediaTypes': {
            ...
            '@Org.OData.Core.V1.Description': 'Lists the MIME types acceptable for the annotated entity type marked with HasStream="true" or the annotated binary, stream, or string property or term',
            '@Org.OData.Core.V1.LongDescription': 'The annotation of a TypeDefinition propagates to the model elements having this type',
        ...
        'MediaType': {
            ...
            '$Nullable': true,
            '$AppliesTo': ['EntityType', 'Property', 'Term', 'TypeDefinition', 'Parameter', 'ReturnType'],
            '@Org.OData.Core.V1.Description': 'The media type of the media stream of the annotated entity type marked with HasStream="true" or the annotated binary, stream, or string property or term',
            '@Org.OData.Core.V1.LongDescription': 'The annotation of a TypeDefinition propagates to the model elements having this type',
            '@Org.OData.Core.V1.IsMediaType': true
        },
        'IsMediaType': {
        ...
        'ContentDisposition': {
            ...
            '@Org.OData.Core.V1.Description': 'The content disposition of the media stream of the annotated entity type marked with HasStream="true" or the annotated binary, stream, or string property or term'
        },
        'ContentDispositionType': {
            '$Kind': 'ComplexType',
            'Type': {
                '$DefaultValue': 'attachment',
                '@Org.OData.Core.V1.Description': 'The disposition type of the binary or stream value, see [RFC 6266, Disposition Type](https://datatracker.ietf.org/doc/html/rfc6266#section-4.2)'
            },
            'Filename': {
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': "The proposed filename for downloading the binary or stream value, see [RFC 6266, Disposition Parameter: 'Filename'](https://datatracker.ietf.org/doc/html/rfc6266#section-4.3)"
            }
        },
        'OptimisticConcurrency': {
            ...
            '$AppliesTo': ['EntitySet'],
            '@Org.OData.Core.V1.Description': "Data modification requires the use of ETags. A non-empty collection contains the set of properties that are used to compute the ETag. An empty collection means that the service won't tell how it computes the ETag"
        },
        ...
        'AutoExpand': {
            ...
            '@Org.OData.Core.V1.Description': 'The service will automatically expand this stream property, navigation property, or the media stream of this media entity type even if not requested with $expand'
        },
        ...
        'MayImplement': {
            ...
            '@Org.OData.Core.V1.Description': 'A collection of qualified type names outside of the type hierarchy that instances of this type might be addressable as by using a type-cast segment.'
        },
        'QualifiedTermName': {
            '$Kind': 'TypeDefinition',
            '$UnderlyingType': 'Edm.String',
        ...
        'Dictionary': {
            '$Kind': 'ComplexType',
            '$OpenType': true,
            '@Org.OData.Core.V1.Description': 'A dictionary of name-value pairs. Names must be valid property names, values may be restricted to a list of types via an annotation with term `Validation.OpenPropertyTypeConstraint`.',
        ...
        'OptionalParameter': {
            ...
            '@Org.OData.Core.V1.LongDescription': 'All parameters marked as optional must come after any parameters not marked as optional. The binding parameter must not be marked as optional.'
        },
        'OptionalParameterType': {
            '$Kind': 'ComplexType',
            'DefaultValue': {
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Default value for an optional parameter of primitive or enumeration type, using the same rules as the `cast` function in URLs.',
                '@Org.OData.Core.V1.LongDescription': 'If no explicit DefaultValue is specified, the service is free on how to interpret omitting the parameter from the request. For example, a service might interpret an omitted optional parameter `KeyDate` as having the current date.'
            }
        },
        'OperationAvailable': {
            '$Kind': 'Term',
            ...
            '@Org.OData.Core.V1.LongDescription': 'The annotation value will usually be an expression, e.g. using properties of the binding parameter type for instance-dependent availability, or using properties of a singleton for global availability. The static value `null` means that availability cannot be determined upfront and is instead expressed as an operation advertisement.'
        },
        'RequiresExplicitBinding': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Action', 'Function'],
            '@Org.OData.Core.V1.Description': 'This bound action or function is only available on model elements annotated with the ExplicitOperationBindings term.'
        },
        'ExplicitOperationBindings': {
            '$Kind': 'Term',
            '$Collection': true,
            '$Type': 'Org.OData.Core.V1.QualifiedBoundOperationName',
            '@Org.OData.Core.V1.Description': 'The qualified names of explicitly bound operations that are supported on the target model element. These operations are in addition to any operations not annotated with RequiresExplicitBinding that are bound to the type of the target model element.'
        },
        'LocalDateTime': {
            '$Kind': 'TypeDefinition',
            '$UnderlyingType': 'Edm.String',
            '@Org.OData.Core.V1.Description': 'A string representing a Local Date-Time value with no offset.',
            '@Org.OData.Validation.V1.Pattern': '^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])T([01][0-9]|2[0-3]):[0-5][0-9](:[0-5][0-9](\\\\.[0-9]+)?)?$'
        },
        'SymbolicName': {
            '$Kind': 'Term',
        ...
        'SimpleIdentifier': {
            ...
            '$UnderlyingType': 'Edm.String',
            '$MaxLength': 128,
            '@Org.OData.Core.V1.Description': 'A [simple identifier](https://docs.oasis-open.org/odata/odata-csdl-xml/v4.01/odata-csdl-xml-v4.01.html#sec_SimpleIdentifier)',
            '@Org.OData.Validation.V1.Pattern': '^[\\p{L}\\p{Nl}_][\\p{L}\\p{Nl}\\p{Nd}\\p{Mn}\\p{Mc}\\p{Pc}\\p{Cf}]{0,}$'
        },
        'GeometryFeature': {
            '$Kind': 'Term',
            '$Type': 'Org.OData.Core.V1.GeometryFeatureType',
            '$Nullable': true,
            '@Org.OData.Core.V1.Description': 'A [Feature Object](https://datatracker.ietf.org/doc/html/rfc7946#section-3.2) represents a spatially bounded thing'
        },
        'GeometryFeatureType': {
            '$Kind': 'ComplexType',
            '@Org.OData.Core.V1.Description': 'A [Feature Object](https://datatracker.ietf.org/doc/html/rfc7946#section-3.2) represents a spatially bounded thing',
        ...
        'AnyStructure': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['EntityType', 'ComplexType'],
            '@Org.OData.Core.V1.Description': 'Instances of a type are annotated with this tag if they have no common structure in a given response payload',
            '@Org.OData.Core.V1.LongDescription': 'The select-list of a context URL MUST be `(@Core.AnyStructure)` if it would otherwise be empty,\n          but this instance annotation SHOULD be omitted from the response value.'
        }
    }
};
//# sourceMappingURL=Org.OData.Core.V1.js.map