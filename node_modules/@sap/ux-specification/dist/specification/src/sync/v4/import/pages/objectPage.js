    ...
    if (typeof actionsDefinition === 'object') {
        for (const actionKey in actionsDefinition['properties']) {
            ...
            if (typeof actionDefinition === 'object' && actionDefinition.$ref) {
                ...
                configActionsPart[actionKey] = factory.createInstance(ux_specification_types_1.PageTypeV4.ObjectPage, schemaPropertyName);
                (0, utils_1.importSettingsOfObject)(configActionsPart[actionKey], importParameters.manifest, importParameters.jsonSchema.definitions[definitionKey], importParameters.routingId, [actionKey], manifestSectionId);
                if (Object.keys(configActionsPart[actionKey]).length === 0) {
                    delete configActionsPart[actionKey];
                }
            }
        }
    }
