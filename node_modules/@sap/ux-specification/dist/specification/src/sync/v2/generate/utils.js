...
exports.hasPropertyTypeError = exports.getUIAnnotationForEntitySet = exports.addStandardFooterActionsOP = exports.addStandardHeaderActions = exports.isEntityUpdatable = exports.isEntityDeletable = exports.isDraftEnabled = exports.addEntityPropertiesToEnum = exports.addSelectionFields = exports.removeElementsFromEnum = exports.processMetadata = exports.addTableColumnExtensions = exports.addFragmentEnum = exports.addTabkeyEnum = exports.addListReportLeadingProperties = exports.addLineItemsType = exports.retrieveNameWithoutVocabularyFromVisualization = exports.handleActionRecord = void 0;
 ...
 * @param {string} propertyName name of the property name to be checked
 * @param {ExtensionLogger} logger - a logger which may receive the error message in case a type error is detected
 * @param {string} expectedType - the expected type of the value of the property (if it is not undefined)
 * @returns {boolean} the information whether a type error was detected. Note that no error is assumed when either parent or parent[propertyName] is undefined
 */
function hasPropertyTypeError(parent, propertyName, logger, expectedType = 'string') {
    const hasTypeError = parent !== undefined &&
        (typeof parent !== 'object' ||
            (parent[propertyName] !== undefined && typeof parent[propertyName] !== expectedType));
    if (hasTypeError) {
