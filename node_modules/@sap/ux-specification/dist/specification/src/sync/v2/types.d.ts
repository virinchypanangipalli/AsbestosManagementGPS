...
export declare const LINEITEMTABLETYPES: string[];
export declare const ALPTABLETYPES: string[];
export declare const OP_STANDARD_HEADER_ACTION_PREFIX = "template::";
export declare const OP_STANDARD_FOOTER_ACTION_PREFIX = "template:::ObjectPageAction:::";
