...
const getPathToGenericSchema = (version, schemaType, directory = __dirname) => {
    ...
    switch (schemaType) {
        case ux_specification_types_2.SchemaType.Application: {
            fileName = `${ux_specification_types_2.SchemaType.Application}${version.toUpperCase()}.json`;
            break;
        }
        case ux_specification_types_2.SchemaType.FPMCustomPage: {
            // Use building blocks generic schema for FPM custom pages
            fileName = `${ux_specification_types_2.SchemaType.BuildingBlocks}Config.json`;
            break;
        }
        default: {
...
const getGenericSchema = async (version, schemaType) => {
    try {
        const path = (0, exports.getPathToGenericSchema)(version || ux_specification_types_1.FioriElementsVersion.v4, schemaType, __dirname);
